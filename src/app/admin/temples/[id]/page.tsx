  ...
  return (
    <div>
      ...
      <dd className="font-body text-sm text-charcoal">
        {value ?? <span className="text-charcoal/25">â€”</span>}
      </dd>
    </div>
  );
}
...
export default function TempleDetailPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (res.ok) router.push("/admin/temples");
      else alert("Failed to delete temple.");
    } catch {
  ...
  if (!temple) {
    return (
      <div className="text-center py-32 font-body text-sm text-charcoal/40">
        Temple not found.{" "}
        <Link href="/admin/temples" className="text-jungle underline">â† Back to Temples</Link>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        {/* â”€â”€ Left column (2/3) â€” detail / edit â”€â”€ */}
                ...
                <dl className="space-y-5">
                  <div>
                    ...
                    <dd className="font-body text-sm text-charcoal leading-relaxed whitespace-pre-line">
                      {temple.description || <span className="text-charcoal/25">â€”</span>}
                    </dd>
                  </div>
                  {temple.history && (
                    <div>
        ...
        {/* â”€â”€ Right column (1/3) â€” related lists â”€â”€ */}
